...
replace (
	...
	k8s.io/apimachinery => github.com/dgrisonnet/kubernetes-apimachinery v0.0.0-20231027121316-ac9f9eae22dd
	k8s.io/apiserver => github.com/dgrisonnet/kubernetes-apiserver v0.0.0-20231024150704-ca5a6e60c5cc
