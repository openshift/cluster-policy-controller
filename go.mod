...
replace (
	...
	k8s.io/apimachinery => github.com/dgrisonnet/kubernetes-apimachinery v0.0.0-20231027121148-a9a8e2b3ca34
	k8s.io/apiserver => github.com/dgrisonnet/kubernetes-apiserver v0.0.0-20231024150651-fb4f44fff283
